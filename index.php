...
<section class="solar-bg">
  <div class="container">
    <div class="solar-container">
      ...
      <br>
      <br>
      <p>Solarite - Patent No. GB1708275.1 converts solar energy to electricity more efficiently and generates 25% more output than conventional solar panels. Solarite have many advantages over conventional solar panels including (but not limited to) lower capital expenditure cost and shorter return on investment period.  Solarite enable these possibilities by using concentration technologies that come with the patents and by using higher efficiency solar cells.</p>
      <br>
      <p>*Solarite was named the Top Finalist at the Shell Make The Future Singapore 2018 and Startup of the week by Enrupt - Disrupting Energy.</p>
      <br>
      <br>
      <img src="img/graphic-chart.png" alt="">
      <br>
      <br>
      <p>In conventional standalone non-grid tie SPV System, solar cell account for 57% of the system cost. Solarite uses only small high efficiency solar cell of at least 20% to 24% efficiency and enhance them to 25% - 32% efficiency. Solarite’s patented hot mirrors reduces the number of solar cell modules which takes up 57% of the cost of a LCPV while increasing conversion efficiency. Reducing the carbon footprint and ensures positive net clean energy.</p>
    </div>
  </div>
</section>
...
<section id="power" class="solar-bg" style="text-align:left;">
  <div class="container">
    <div class="solar-container">
      ...
      <br>
      <p>A new blockchain concept: Proof-of-Power</p>
      <br>
      <p>Solarite blockchain employs the Proof-of-Power (PoP) concept. Eight Solarite panels make up one Solarite Masternode. Stakeholders stake their coins on Solarite Masternodes which performs transactions and verifications. The higher the amount of coins stake on Solarite Masternode, the higher the authority stakeholders have in winning a transaction verifications.</p>
      <br>
      <p>Solarite Blockchain will be based on the first Solarite Solar Farm that the company builds. Subsequent solar farms and installation that builds with Solarite Technologies leverage on Solarite Blockchain for transaction verification creating massive use case for Solarite utility tokens. The Proof-of-Power (PoP) concept uses much lesser amount of electricity to mine Solarite TAPP Tokens. The excess electricity generated by Solarite’s Solar Farm will be sold back to the grid and generate value for token holders.</p>
    </div>
  </div>
</section>
<section id="tokeneco">
...
<section id="crypto" class="cloud-bg">
  <div class="container">
    ...
    <div class="col-md-6 v-pad">
      ...
      <br>
      <p>The Solarite Platform provides a transparent governance framework that allows the Ecosystem to seamlessly interface with energy markets around the globe, bringing innovation and a wide range of network benefits to consumers and enabling all 4 groups of market players with market power in any transactive arrangement.</p>
      <br>
...
<section id="funds" class="solar-bg">
  <div class="container">
    <div class="solar-container">
      ...
      <br>
      <p>Solarite proprietary Proof of Power blockchain will be developed as we raise the funds from this TGE, once this private blockchain is live, we will be conducting a token swap for all TAPP Token holders to convert their ERC20 token to the Proof of Power blockchain.</p>
      <br>
      <br>
      <br>
...
<section id="contact" class="cloud-bg contact-bg">
  <div class="container">
    ...
    <br>
    <br>
    <h2>investors@solarite-technology.com</h2>
    <br>
    <br>
    <br>
