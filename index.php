...
<section id="team" style="background:#f5f5f5;">
  <div class="container">
	...
	<div class="row wow fadeInUp" style="text-align:center;">
      <div class="col-md-2 vol-sm-4 col-xs-6 v-pad">
        <a href="#peter" class="open-popup-link"><div class="team-circle"><div class="team-img"><img src="img/team-peter.jpg" alt=""></div></div></a>
        <br>
...
<div id="peter" class="white-popup team-popup mfp-hide sans">
  <div class="popup-title">
	<h1><b>Peter</b> Lim</h1>
    <h2><i class="fa fa-linkedin-square" aria-hidden="true"></i> Advisor</h2>
  </div>
  <br><br>
  <div style="padding-left:25px;">
  <p>Co-founder & Chief Strategy Officer of PLMP FINTECH, Asia biggest Blockchain Technologies center housing 50,000 sqft of full end to end ICO launch advisory,  blockchain developer and solutions center, Crypto exchange OTC services and support center  , Blockchain innovators incubator and  mega rig mining farm.</p>
  <br>
  <p>Peter Lim diverse portfolio dating back from IT industry to infocomm  and was actively involved in Dot.com startup funding. He was hand picked under EDB SEEDS Entrepreneurship and was team member of CHINA – SINGAPORE Information Technology Collaboration 2000 to 2003 developing vast experience in conceptualizing, marketing, organizing and executing successful venture in major IT infrastructure projects in both China and India.</p>
  <br>
  <p>Peter other portfolio including Hedge Fund and FX Proprietary trading and institutional order flow trader since 1997 graduated from Institute of Banking and Finance (IBF).</p>
  <br>
  <p>Under his stewardship PLMP FINTECH and its core executives team have position itself as the biggest Blockchain and Cryptocurrency Service and Support Center in Asia embarking empowering SME into the new Digital Economy.</p>
  </div>
</div>
